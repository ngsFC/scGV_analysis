...
Gene networks (GRNs) provide crucial insights into cellular function and disease mechanisms. Here, we apply the Joint Random Forest (JRF) algorithm to infer robust GRNs from PBMC data.
...
seurat_subset_filt <- readRDS("/home/francescoc/Desktop/network/graphwork/analysis/casestudy/PBMC.top600.RDS")
...
top_interactions_custom <- lapply(c(3, 7, 9), function(comm) {
  ...
  if (nrow(selected_pathways) == 0) {
    cat("⚠️  No matching pathways found for community", comm, "\n")
